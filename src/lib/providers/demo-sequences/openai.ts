...
export async function mockFetchMetrics(): Promise<SnapshotResult[]> {
  return [
    ...
    { collectorId: 'api_requests', value: 8420, valueText: null, unit: 'requests', status: 'healthy' },
...
export const demoSnapshots: DemoSnapshot[] = [
  ...
  { collectorId: 'api_requests', value: 5200, valueText: null, unit: 'requests', status: 'healthy', hoursAgo: 48 },
  ...
  { collectorId: 'api_requests', value: 6800, valueText: null, unit: 'requests', status: 'healthy', hoursAgo: 24 },
  ...
  { collectorId: 'api_requests', value: 8420, valueText: null, unit: 'requests', status: 'healthy', hoursAgo: 0 },
