...
export async function mockFetchMetrics(): Promise<SnapshotResult[]> {
  return [
    ...
    { collectorId: 'apdex', value: 0.82, valueText: null, unit: '', status: 'healthy' },
...
export const demoSnapshots: DemoSnapshot[] = [
  ...
  { collectorId: 'apdex', value: 0.92, valueText: null, unit: '', status: 'healthy', hoursAgo: 48 },
  ...
  { collectorId: 'apdex', value: 0.87, valueText: null, unit: '', status: 'healthy', hoursAgo: 24 },
  ...
  { collectorId: 'apdex', value: 0.82, valueText: null, unit: '', status: 'healthy', hoursAgo: 0 },
